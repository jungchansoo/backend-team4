...
public class KakaoPayService {
    ...
    public String kakaoPayReady(String item_name, String price) {
        ...
        params.add("approval_url", "http://studywithme.store/kakaoPaySuccess");
        params.add("cancel_url", "http://studywithme.store/kakaoPayCancel");
        params.add("fail_url", "http://studywithme.store/kakaoPaySuccessFail");
